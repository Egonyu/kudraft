...
<div class="ku-breadcrumbs">
    <div class="ku-breadcrumbs-container ku-container">
        <div class="ku-breadcrumbs-item ku-item-pdlr"> <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to ku." href=" {{ route('home') }} " class="home"><span property="name">Home</span></a>
            ...
            </span>&gt;<span property="itemListElement" typeof="ListItem"><span property="name">Kampala University</span>
                                ...
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" id="div_983a_4">
                                        <div class="gdlr-core-title-item-title-wrap clearfix">
                                            <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " id="h3_983a_0">Quality Assurance</h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="gdlr-core-pbf-element">
                                ...
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                        <div class="gdlr-core-text-box-item-content" id="div_983a_7">
                                            <p>
                                                Kampala University has a fully-fledged Quality Assurance Unit and is committed to the highest standards of quality in its operations.
                                                It is headed by a Quality Assurance Manager deputised by a Quality Assurance Officer , Quality Assurance Assistant and Quality Assurance personnel across the campuses.
                                                Our Quality Assurance is guided by the NCHE Quality Assurance Hand book, IUCEA Quality Assurance Hand Books (1- 4) and other International Academic Standards.
                                                Kampala University is a founder member of Ugandan Universities Quality Assurance Forum (UUQAF) & East African Quality Assurance Network (EAQAN).
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                        <div class="gdlr-core-text-box-item-content" id="div_983a_8">
                                            <h6>How Quality Assurance is emphasized at Kampala University</h6>
                                            <p>There is a Quality Assurance Hand Book and Policy that guides the QA procedures in the running of University Activities such as:
                                            The quality of teaching and learning- Pedagogical skills to all lectures without a teaching background.</p>
                                            <ul>
                                                <li>External examiners.</li>
                                                <li>Students evaluation forms.</li>
                                                <li>Curriculum review.</li>
                                                <li>Regular audits through self-assessment of all schools.</li>
                                                <li>Regular trainings of all categories of staff.</li>
                                                <li>Guild participation in Q.A.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js  gdlr-core-sync-height-content">
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" id="div_983a_26">
                                        <div class="gdlr-core-title-item-title-wrap clearfix">
                                            <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " id="h3_983a_4">Functions of Quality Assurance Directorate</h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                        <div class="gdlr-core-text-box-item-content" id="div_983a_27">
                                            <ol>
                                                <li>Quality of staff is enhanced.</li>
                                                <li>Quality in teaching and learning is improved upon.</li>
                                                <li>Improved and sustained quality in academic programmes</li>
                                                <li>Quality in support services is enhanced.</li>
                                                <li>Quality in community engagement services continuously improve.</li>
                                                <li>Quality of resources and facilities continuously improve.</li>
                                                <li>Quality of research and publication is maintained high.</li>
                                            </ol>
                                        </div>
                                    </div>
                                </div>
