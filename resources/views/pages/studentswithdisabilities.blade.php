...
<div class="ku-page-title-wrap  ku-style-custom ku-left-align" id="div_983a_0">
    ...
    <div class="ku-page-title-container ku-container">
        <div class="ku-page-title-content ku-item-pdlr" id="div_983a_1">
            ...
            <h1 class="ku-page-title" id="h1_983a_0">Students with Disabilities</h1></div>
    </div>
</div>
                                ...
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                        <div class="gdlr-core-text-box-item-content" id="div_983a_7">
                                            <p>Kampala University has an institutional commitment to ensure an integrated and inclusive learning experience for students with disabilities. Accordingly, the Disability Unit aims to create an enabling environment by providing support to students with disabilities.
                            ...
                            <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                                ...
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" id="div_983a_16">
                                        <div class="gdlr-core-title-item-title-wrap clearfix">
                                            <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " id="h3_983a_2">ku's Principle</h3></div>
                                    </div>
                                </div>
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
        ...
        <div class="gdlr-core-pbf-sidebar-content  gdlr-core-column-40 gdlr-core-pbf-sidebar-padding gdlr-core-line-height gdlr-core-column-extend-left" style="padding: 40px 0px 30px 0px;">
            <div class="gdlr-core-pbf-sidebar-content-inner">
                ...
                <div class="gdlr-core-pbf-element">
                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                        <div class="gdlr-core-text-box-item-content" style="font-size: 16px ;text-transform: none ;">
                            <p>In efforts to create an integrated and inclusive learning environment for students with disabilities, the Disability Unit offers the following services:
                            </p>
                            <ul>
                                <li>Advocacy and advice on any disability related matters.</li>
                                <li>Consultative and counselling services for students with disabilities.</li>
                                <li>Assistive technological services: screenings, trainings and support to students with disabilities regarding a variety of assistive computer technologies and software applications available at the DU’s computer lab. Training sessions are available by request.</li>
                                <li>Adapted text arrangements: Conversion of study material into accessible formats.</li>
                                <li>Facilitation of test and examination accommodations for students with disabilities.</li>
                                <li>Test and Exam Concession applications (relevant supporting medical report required and registration with DU).</li>
                                <li>Orientation and mobility training.</li>
                                <li>Academic support for students with learning disabilities.</li>
                                <li>Psycho-social support for students with disabilities.</li>
                                <li>Referrals for recommended textbooks in electronic format.</li>
                                <li>Accessible study venues and a computer lab.</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="gdlr-core-pbf-element">
                    <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr">
                        <div class="gdlr-core-title-item-title-wrap clearfix">
                            <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 29px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;">Student Responsibility</h3></div>
                    </div>
                </div>
                <div class="gdlr-core-pbf-element">
                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                        <div class="gdlr-core-text-box-item-content" style="font-size: 16px ;text-transform: none ;">
                            <p>All students with disabilities bear the responsibility to timely request the assistance of the Disability Unit as well as to provide any documentation of conditions that may warrant academic accommodations. In addition it is the responsibility of the student to:</i> </p>
                            <ul>
                                <li>Register with the Disability Unit as early as possible and submit documentation of disability as a prerequisite to receiving academic accommodations.</li>
                                <li>“Letters of Accommodation” that detail your disability-related needs must be discussed with lecturers and other relevant faculty members. </li>
                                <li>Concession applications for additional time must be submitted to the DU no later than April 30th, for first semester assessments and September 30th for second semester assessments. Engineering students kindly note applications must be submitted at least a week prior to Engineering Week assessments. </li>
                                <li>Make timely applications for test and examination arrangements. All requests to be submitted to the DU no later than a week before the assessment.</li>
                                <li>Provide for personal disability-related needs or services such as personal care attendants.</li>
                                <li>Meet the same academic standards expected of all UP students.</li>
                            </ul>
                        </div>
                    </div>
                </div>
