...
@section('content')
<div class="ku-page-title-wrap  ku-style-custom ku-left-align" id="div_983a_0-sports">
                    ...
                    <div class="gdlr-core-pbf-sidebar-content-inner">
                        <div class="gdlr-core-pbf-element">
                            <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr">
                                <div class="gdlr-core-title-item-title-wrap clearfix">
                                    <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 29px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;">Recreation & Sports</h3></div>
                            </div>
                        </div>
                        <div class="gdlr-core-pbf-element">
                            <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                <div class="gdlr-core-text-box-item-content" style="font-size: 16px ;text-transform: none ;">
                                    <p>There are number of recreation and sports activities at the University. The Department of Sports and Recreation offers welfare and sports skills services to the students through a comprehensive, dynamic and exciting Inter-Hall Sports Championships, and several other internally organized competitions. The games include:</p>
                        ...
                        <div class="gdlr-core-pbf-element">
                            <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 40px ;">
                                <div class="gdlr-core-title-item-title-wrap clearfix">
                                    <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 22px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;margin-right: 30px ;">Famous University Activities</h3>
                                        ...
                                        <div class="gdlr-core-feature-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-center-align">
                                            <div class="gdlr-core-feature-box gdlr-core-js gdlr-core-feature-box-type-outer" style="background-color: #3db166 ;border-width: 0px 0px 0px 0px;border-radius: 3px;-moz-border-radius: 3px;-webkit-border-radius: 3px;">
                                                ...
                                                <div class="gdlr-core-feature-box-content gdlr-core-sync-height-content">
                                                    <h3 class="gdlr-core-feature-box-item-title" style="font-size: 16px ;font-weight: 600 ;">Soccor Football</h3></div>
                        ...
                        <div class="gdlr-core-pbf-element">
                            <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 40px ;">
                                <div class="gdlr-core-title-item-title-wrap clearfix">
                                    <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 22px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;margin-right: 30px ;">Get Engaded In Sports</h3>
                                    <div class="gdlr-core-title-item-divider gdlr-core-right gdlr-core-skin-divider" style="font-size: 22px ;border-bottom-width: 3px ;"></div>
                                </div>
                            </div>
                        </div> --}}
                            ...
                            <div class="gdlr-core-accordion-item gdlr-core-item-pdlr gdlr-core-item-pdb  gdlr-core-accordion-style-icon">
                                <div class="gdlr-core-accordion-item-tab clearfix  gdlr-core-active">
                                    ...
                                    <div class="gdlr-core-accordion-item-content-wrapper">
                                        <h4 class="gdlr-core-accordion-item-title gdlr-core-js ">Student Games</h4>
                                        <div class="gdlr-core-accordion-item-content">
                                            <ul>
                                                <li>Athletics (men and women)</li>
                                                <li>Badminton (men and women)</li>
                                                <li>Basketball (men and women)</li>
                                                <li>Chess (men and women)</li>
                                                <li>Darts (men and women)</li>
                                                <li>Football (men and women)</li>
                                                <li>Handball (men and women)</li>
                                                <li>Karate (men and women)</li>
                                                <li>Kick Boxing (men and women)</li>
                                                <li>Netball (men and women)</li>
                                                <li>Table Tennis (men and women)</li>
                                                <li>Tae-Kwando (men and women)</li>
                                                <li>Volleyball (men and women)</li>
                                                <li>Wood ball (men and women</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="gdlr-core-accordion-item-tab clearfix ">
                                    ...
                                    <div class="gdlr-core-accordion-item-content-wrapper">
                                        ...
                                        <div class="gdlr-core-accordion-item-content">
                                            ...
                                            <ul>
                                                <li>East African University Games</li>
                                                <li>East, Central and Southern Africa University Games</li>
