                    ...
                    <div class="events-content">
                        <ol>
                            <li class="selected" data-date="16/01/2017">
                                <h4>
                                    <img class="rounded float-left m-r-15" width="40" alt="user" src="../assets/img/sm/avatar1.jpg" alt="user"> Horizontal Timeline<br/>
                            ...
                            <li data-date="28/02/2017">
                                <h4>
                                    <img class="rounded float-left m-r-15" width="40" alt="user" src="../assets/img/sm/avatar2.jpg" alt="user"> Horizontal Timeline<br/>
                            ...
                            <li data-date="20/04/2017">
                                <h4>
                                    <img class="rounded float-left m-r-15" width="40" alt="user" src="../assets/img/sm/avatar3.jpg" alt="user"> Horizontal Timeline<br/>
                            ...
                            <li data-date="20/05/2017">
                                <h4>
                                    <img class="rounded float-left m-r-15" width="40" alt="user" src="../assets/img/sm/avatar4.jpg" alt="user"> Horizontal Timeline<br/>
                            ...
                            <li data-date="09/07/2017">
                                <h4>
                                    <img class="rounded float-left m-r-15" width="40" alt="user" src="../assets/img/sm/avatar5.jpg" alt="user"> Horizontal Timeline<br/>
                            ...
                            <li data-date="30/08/2017">
                                <h4>
                                    <img class="rounded float-left m-r-15" width="40" alt="user" src="../assets/img/sm/avatar6.jpg" alt="user"> Horizontal Timeline<br/>
