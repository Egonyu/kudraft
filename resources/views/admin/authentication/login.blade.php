	...
	<div class="vertical-align-middle auth-main">
		<div class="auth-box">
			...
			<div class="card">
                ...
                <div class="body">
                    <form class="form-auth-small" action="{{route('admin.dashboard.university')}}">
                        ...
                        <div class="bottom">
                            ...
                            <span>Don't have an account? <a href="{{route('admin.authentication.register')}}">Register</a></span>
                        </div>
                    </form>
                </div>
            </div>
