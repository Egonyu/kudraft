...
@section('content')
<div class="ku-page-title-wrap  ku-style-custom ku-left-align" id="div_983a_0_artsUnderGrad">
    ...
    <div class="ku-page-title-container ku-container">
        <div class="ku-page-title-content ku-item-pdlr" id="div_983a_1">
            ...
            <h1 class="ku-page-title" id="h1_983a_0">Arts and Social Sciences.</h1></div>
    </div>
</div>
                        ...
                        <div class="gdlr-core-pbf-sidebar-content-inner">
                            ...
                            <div class="gdlr-core-pbf-element">
                                <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                    <div class="gdlr-core-text-box-item-content" style="font-size: 16px ;text-transform: none ;">
                                        <p>The degree Programmes provide a framework and practical techniques for effective and efficient management and use of resources and opportunities for sustainable economic development and social change. Impart learners with skills in the management and solving of social problems.</p>
                                        <p>Study societal problems and lobby for policies to address those problems.</p>
                            ...
                            <div class="gdlr-core-pbf-element">
                                <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 15px ;">
                                    <div class="gdlr-core-text-box-item-content" style="font-size: 16px ;text-transform: none ;">
                                        <h6>Objectives Of the Programme.</h6>
                                        <p>
                                            <ul>
                                                <li>To provide a foundation for professional social workers and counsellors by imparting knowledge and skills to graduates that meet career requirements of managers in the private and public sectors.</li>
                                                <li>To produce graduates with quality social work and counselling training that will contribute to national and international economic growth and development.</li>
                                            </ul>
                                        </p>
                                        <h6>Short courses.</h6>
                                        <ol>
                                            <li>Guidances & Counseling.</li>
                                            <li>Radio and television production.</li>
                                            <li>Radio and television news writing.</li>
                                            <li>Introduction to public relations.</li>
                                            <li>News Editing and Design.</li>
                                            <li>Reseach writing.</li>
                                            <li>Art of public speaking.</li>
                                            <li>Hiv/Aids Counseling.</li>
                                            <li>Crisis Management.</li>
                                            <li>Martial Counselling.</li>
                                            <li>Stress Management.</li>
                                            <li>Group and family counseling.</li>
                                            <li>Development policy planning.</li>
