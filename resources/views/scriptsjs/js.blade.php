...
<script type="text/javascript" src="plugins/revslider/public/assets/js/extensions/revolution.extension.video.min.js"></script>
    ...
    <script type='text/javascript'>
        var gdlr_core_pbf = {
            ...
            "ajax_url": "https:\/\/demo.goodlayers.com\/ku\/wp-admin\/admin-ajax.php"
        };
    </script>
    ...
    <script type='text/javascript'>
        var ku_script_core = {
            "home_url": "https:\/\/demo.goodlayers.com\/ku\/"
        };
    </script>
	        ...
	        function onLoad() {
	            ...
	            if (tpj("#rev_slider_1_1").revolution == undefined) {
	                ...
	                revapi1 = tpj("#rev_slider_1_1").show().revolution({
	                    sliderType: "standard",
	                    jsFileLocation: "//demo.goodlayers.com/ku/wp-content/plugins/revslider/public/assets/js/",
	                    sliderLayout: "auto",
	                    dottedOverlay: "none",
	                    delay: 9000,
	                    navigation: {
